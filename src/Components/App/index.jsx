...
import WhoIsLogistico from './whoIsLogistico'
import ToDoLogistico from './toDoLogistico'
      ...
      <footer class="isolate mx-auto max-w-7xl p-6 pb-12 pt-16 lg:px-8">
        <div class="border-t border-white/10 pt-4 md:flex md:items-center md:justify-between">
          <div class="flex justify-center space-x-6 md:order-2">
            <a target="_blank" rel="noopener noreferrer" aria-label="Follow on X (formerly Twitter)" class="group flex h-6 w-6 items-center justify-center text-zinc-400 transition hover:text-zinc-300" href="https://twitter.com/joincobalt">
              ...
              <svg fill="currentColor" viewBox="0 0 16 16" aria-label="X" stroke-linecap="round" stroke-linejoin="round" class="h-4 w-4 group-hover:hidden" aria-hidden="true">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M0.5 0.5H5.75L9.48421 5.71053L14 0.5H16L10.3895 6.97368L16.5 15.5H11.25L7.51579 10.2895L3 15.5H1L6.61053 9.02632L0.5 0.5ZM12.0204 14L3.42043 2H4.97957L13.5796 14H12.0204Z">
                </path>
              </svg>
            </a>
            <a target="_blank" rel="noopener noreferrer" aria-label="Follow on LinkedIn" class="group flex h-6 w-6 items-center justify-center text-zinc-400 transition-colors hover:text-zinc-300" href="https://www.linkedin.com/company/cobaltfinancial">
            ...
            <a target="_blank" rel="noopener noreferrer" aria-label="Follow on Facebook" class="group flex h-6 w-6 items-center justify-center text-zinc-400 transition-colors hover:text-zinc-300" href="https://www.facebook.com/joincobalt">
              <svg fill="currentColor" viewBox="0 0 24 24" aria-label="Facebook" class="h-5 w-5" aria-hidden="true"><path fill-rule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clip-rule="evenodd">
              </path>
              </svg>
            </a>
          </div>
          <div class="mt-8 flex items-center gap-4 text-xs font-medium leading-5 text-zinc-400 max-md:flex-col md:order-1 md:mt-0">
            <div class="order-2 md:order-1">
              <p class="">© 2025 by Alejandro Galeano Madrigal.</p>
            </div>
            <div class="order-1 flex gap-4 md:order-2">
              <a class="transition-colors duration-200 hover:text-zinc-300" href="/legal/privacy">Privacy Policy</a>
              <a class="transition-colors duration-200 hover:text-zinc-300" href="/legal/terms">Terms of Use</a>
            </div>
          </div>
        </div>
        <div class="mt-4 w-full text-xs leading-5 text-zinc-500 max-md:text-center md:max-w-[60%]">
          ...
          <p class="mt-2">Logitico es un asistente conversacional especializado en logística, y no una empresa dedicada al transporte. Ciertas funcionalidades pueden estar integradas con servicios de terceros autorizados, según los requerimientos del usuario.</p>
        </div>
      </footer>
    </>
  )
